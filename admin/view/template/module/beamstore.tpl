					...
					<div id="tab_design" class="tab-content2">
						...
						<div id="tab_colors" class="tab-content">
							...
							<div class="colors_left">
								...
								<!-- Input -->
								<div class="color_input">
									<p>Cart arrow background gradient top:</p>
								...
								<!-- Input -->
								<div class="color_input">
									<p>Cart arrow background gradient bottom:</p>
							...
							<div class="colors_left">
								...
								<!-- Input -->
								<div class="color_input">
									<p>Icon home background top color:</p>
								...
								<!-- Input -->
								<div class="color_input">
									<p>Icon home background bottom color:</p>
