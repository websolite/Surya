...
<div id="cart_block" class="dropdown">
	<div class="cart-heading dropdown-toogle" data-hover="dropdown" data-toggle="dropdown">
		<i class="cart-icon"></i>
		<p><span id="text-cart"><?php if($theme_options->get( 'shopping_cart_text', $config->get( 'config_language_id' ) ) != '') { echo html_entity_decode($theme_options->get( 'shopping_cart_text', $config->get( 'config_language_id' ) )); } else { echo 'Shopping cart'; } ?>:</span> <span id="cart-total"><?php echo $text_items; ?></span></p>
		<div></div>
	</div>
